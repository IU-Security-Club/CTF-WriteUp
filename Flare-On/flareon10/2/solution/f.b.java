...
public final class b {
    ...
    /* renamed from: b */
    private final byte[] encrypt(String str, byte[] bArr, SecretKeySpec secretKeySpec, IvParameterSpec ivParameterSpec) {
    ...
    /* renamed from: c */
    private final File save_output_to_file(int i2, Context context) {
        Resources resources = context.getResources();
        Intrinsics.checkNotNullExpressionValue(resources, "context.resources");
        byte[] streamValue = getStreamValue(resources, i2);
        String key_arr = key_arr(context);
        Charset charset = Charsets.UTF_8;
        byte[] bytes = key_arr.getBytes(charset);
        ...
        byte[] encrypt = encrypt(string, streamValue, secretKeySpec, new IvParameterSpec(bytes2));
    ...
    /* renamed from: d */
    private final String key_arr(Context context) {
        String slice;
    ...
    /* renamed from: e */
    private final byte[] getStreamValue(Resources e2, int i2) {
        Throwable th;
    ...
    public final Intent f(@NotNull Context context, int i2) {
        ...
        Uri uriForFile = FileProvider.getUriForFile(context, Intrinsics.stringPlus(context.getApplicationContext().getPackageName(), context.getString(R.string.prdr)), save_output_to_file(i2, context));
